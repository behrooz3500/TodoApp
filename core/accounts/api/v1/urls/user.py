...
urlpatterns = [
    ...
    path('token/simple/logout/', views.TokenLogoutAPIView.as_view(), name='token-logout'),

    path('token/jwt/create/', views.CustomTokenObtainPairView.as_view(), name='token-create'),
    ...
    path('password/reset/<str:token>', views.PasswordResetConfirmAPIView.as_view(), name='password-reset'),


    path('test-mail/', views.TestMailSender.as_view(), name='test-mail'),
    path('activation/<str:token>', views.AccountActivationAPIView.as_view(), name='activation'),
    path('activation/resend/', views.AccountResendTokenAPIView.as_view(), name='resend-token')
]
